...
{
    options.SwaggerDoc("v1", new OpenApiInfo { Title = ".NET Core API Testing", Version = "v1" });
    options.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme
    {
        Description = @"Authenticated by login to get the JWT, then fill the box with following format 'Bearer' [space] your token to get authorized. Example: 'Bearer 1234abcdef'",
        Name = "Authorization",
...
//EF Core - MS.Extensions.Diagnostics.HealthChecks.EntityFramworkCore
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "TestingAPI-backlue");
